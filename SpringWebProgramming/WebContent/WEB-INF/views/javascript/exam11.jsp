...
//DOM -> Document - HTML문서 전체를 표현하는 객체-> 
				...
				img.src = "<%=application.getContextPath()%>/resources/image/photo02.jpg";  // 이미지의 경로 변경    //
			...
			function handleBtn2() {
				...
				img1.src = "<%=application.getContextPath()%>/resources/image/photo04.jpg";
			...
			function handleBtn3() {
				...
				for (var i = 0; i < class1.length; i++) {
					class1[i].src = "<%=application.getContextPath()%>/resources/image/photo05.jpg";
				}
