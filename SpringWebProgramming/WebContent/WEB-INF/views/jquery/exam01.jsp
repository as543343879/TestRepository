	...
	<head>
		...
		<script>
			...
			function handleBtn1() {
				...
				imgArray.attr("src","<%=application.getContextPath()%>/resources/image/photo02.jpg"); //attr은 해당 배열의 각각을 빼내서 src속성을 해당 주소로 바꾼다는 의미

                  }
			function handleBtn2() {

				var img1= $("#img1");
				img1.attr("src","<%=application.getContextPath()%>/resources/image/photo03.jpg"); //attr은 해당 배열의 각각을 빼내서 src속성을 해당 주소로 바꾼다는 의미


			}
			function handleBtn3() {
				var class1=$(".class1");
				class1.attr("src","<%=application.getContextPath()%>/resources/image/photo05.jpg");
				}
