	...
	<head>
		...
		<script>
			function handleBtn1() {   //조각을 받아서 사용한 방법
				$.ajax({
					url: "/WebApplication/jquery/exam04_html_fragment", //여기서 데이터를 다 받고 나면 자동으로 success 메소드 실행 
			...
			function handleBtn2() {          //json 데이터를 받아서 사용한방법
				$.ajax({
					url: "/WebApplication/jquery/exam04_json", //여기서 데이터를 다 받고 나면 자동으로 success 메소드 실행  //json 데이터를 받아서 변경한것
					success: function (data) {
