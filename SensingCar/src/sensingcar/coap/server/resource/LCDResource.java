...
public class LCDResource extends CoapResource {
	...
	//{"command":"change","line0":"xxxxx","line1":"xxx"} 이런식으로
	//{"command":"status"} 이런식으로 요청
		...
		if (command.equals("change")) {
			String lin0=requestJsonObject.getString("line0");
			String lin1=requestJsonObject.getString("line1");
			setText(lin0, lin1);
