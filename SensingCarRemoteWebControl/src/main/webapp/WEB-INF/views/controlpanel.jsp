					...
					<div class="row">
						<div class="col-md-5">
							<div style="height:210px;">
								<img class="img-responsive"  src="<%=application.getContextPath()%>/resources/image/sensingcar.jpg" style="width:100%;height:100%;"/>
							</div>
						</div>
						<div class="col-md-3">
							<div  style="height:210px;">
						...
						<div class="col-md-4">
							<div style="background: linear-gradient(#737373, black); color: white; height:210px; padding: 5px;">
								...
								<div style="text-align: center;">
									좌우<br/>
									<button id="btnLeftrright180" type="button" class="btn btn-danger" onclick="camera('change','180', '${updown}')">&lt;&lt;</button> 
									<button id="btnLeftrright135" type="button" class="btn btn-warning" onclick="camera('change','135', '${updown}')">&lt;</button> 
									<button id="btnLeftrright90" type="button" class="btn btn-default" onclick="camera('change','90', '${updown}')">정면</button>                                    
									<button id="btnLeftrright45" type="button" class="btn btn-info" onclick="camera('change','45', '${updown}')">&gt;</button>
									<button id="btnLeftrright0" type="button" class="btn btn-primary" onclick="camera('change','0', '${updown}')">&gt;&gt;</button>                                    
									<br/><br/>상하<br/>
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<div style="background: linear-gradient(#737373, black); color: white; height:150px; background-color: lightgray; padding: 5px; margin-top: 20px;">
								...
								<div style="text-align: center">현재 상태: <span id="ultrasonicsensorStatus">angle=${angle}; distance=${distance}</span></div>
								<br/>
								<div style="text-align: center;">
					...
					<div class="row">
						<div class="col-lg-4">
							<div style="background: linear-gradient(#737373, black); color: white; height:180px; background-color: lightgray; padding: 5px; margin-top: 20px;">
								...
								<div style="text-align: center">현재 상태: <br/><span id="lcdStatus">line0: ${line0}<br/>line1: ${line1}</span></div>
								<br/>
								<div style="padding-left: 20px;">
									<table style="width:100%">
										<tr>
											<td style="width:70%">
												Line0: <input id="lcdline0" type="text" maxlength="16" value="${line0}" style="color: black; width:120px;"/><br/>
												Line1: <input id="lcdline1" type="text" maxlength="16" value="${line1}" style="color: black; width:120px;"/>
											</td>
											<td style="width:30%">
						...
						<div class="col-lg-3">
							<div style="background: linear-gradient(#737373, black); color: white; height:150px; background-color: lightgray; padding: 5px; margin-top: 20px;">
								...
								<div style="text-align: center">현재 상태: <span id="fronttireStatus">angle :  ${angle}</span></div>
								<br/>
								<div style="text-align: center;">
						...
						<div class="col-lg-5">
							<div style="background: linear-gradient(#737373, black); color: white; height:150px; background-color: lightgray; padding: 5px; margin-top: 20px;">
								...
								<div style="text-align: center">현재 상태: <span id="backtireStatus"><br/>진행방향: ${direction}<br/>단계: ${speed}</span></div>
								<br/>
								<div style="text-align: center;">
									...
									<button id="btnSpeed1"  onclick="backtire('change' ,  ' ${direction}'  , '600')" style="color: black;">1</button>
									<button id="btnSpeed2"  onclick="backtire('change',  ' ${direction}'  , '1036')" style="color: black;">2</button>
									<button id="btnSpeed3"  onclick="backtire('change', ' ${direction}'  , '1472')" style="color: black;">3</button>
									<button id="btnSpeed4"  onclick="backtire('change',  ' ${direction}'  ,'1908')" style="color: black;">4</button>
									<button id="btnSpeed5"  onclick="backtire('change', ' ${direction}'  , '2344')" style="color: black;">5</button>
									<button id="btnSpeed6"  onclick="backtire('change', ' ${direction}'  , '2780')" style="color: black;">6</button>
									<button id="btnSpeed7"  onclick="backtire('change', ' ${direction}'  , '3216')" style="color: black;">7</button>
									<button id="btnSpeed8"  onclick="backtire('change', ' ${direction}'  , '3352')" style="color: black;">8</button>
									<button id="btnSpeed9"  onclick="backtire('change', ' ${direction}'  , '3654')" style="color: black;">9</button>
									<button id="btnSpeed10"  onclick="backtire('change', ' ${direction}'  , '4095')" style="color: black;">10</button>
								</div>                                      
							</div> 
						</div>
					</div>          
